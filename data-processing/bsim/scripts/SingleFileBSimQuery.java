...
public class SingleFileBSimQuery extends GhidraScript {
    ...
    protected void run() throws Exception {
         ...
         * $ ./analyzeHeadless <project location> <project name> \
            -import [file] \
            -postScript SingleFileBSimQuery <base output dir> <BSim URL> \
         ...
         * To use with the mulithreader use something like
            mt_script = PostScriptMultithreader(
                ...
                ghidra_script_name="SingleFileBSimQuery",
	...
	private void printFunctionQueryResults(List<BSimMatchResult> resultRows, File outFile) throws FileNotFoundException{
        ...
        try (PrintStream out = new PrintStream(new FileOutputStream(outFile))) {
            for (BSimMatchResult resultRow : resultRows) {
                String query = resultRow.getOriginalFunctionDescription().getFunctionName();
                String match = resultRow.getMatchFunctionDescription().getFunctionName();
